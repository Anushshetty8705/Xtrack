...
const handlechangeuse = (e) => {
  ...
  return (
    <>
      ...
      <div className="  flex ">
        <Image
          className="rounded-3xl  animate-fade-in-center relative  hide bg-purple-900/30 my-auto mx-35 h-[82vh]"
          src="/home.png"
          width={500}
          height={500}
          alt="home"
        />
        <div className=' box animate-fade-in-center p-10 rounded-3xl relative  m-20 mr-35  flex items-center justify-center flex-col bg-purple-900/30'>
          ...
          <div className="flex flex-col w-full justify-center items-center">
            ...
            />
            <div className='error2 text-red-500 w-80  font-medium mb-5 mr-30'>{error}</div>
            ...
            <div className='error2 text-red-500 w-80  font-medium mr-30'>{passwerror}</div>
           <Link href={"/forgotpassword"}> <div className="forgot justify-start mb-5 text-blue-600 pas">Forgotten password?</div></Link>
          </div>
