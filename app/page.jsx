...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="  flex ">
        <Image
          className="rounded-3xl  animate-fade-in-center relative  hide bg-blue-900/20  my-auto mx-35 h-[82vh]"
          src="/home.png"
          width={500}
          height={500}
          alt="home"
        />
        <div className=' box animate-fade-in-center p-10 rounded-3xl relative  m-20 mr-35  flex items-center justify-center flex-col bg-blue-900/20'>
