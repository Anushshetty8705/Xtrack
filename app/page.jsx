  ...
  const handleLogin = () => {
    if (username.length === 0) {
      ...
      setTimeout(() => {
        ...
        toast.success('Logging failed', {
          icon: '😔',
          style: {
            fontSize: '18px',
            borderRadius: '10px',
            background: '#990000 ', // green
            color: '#fff',
            fontWeight: '600',
            padding: '12px 24px',
          },
        ...
        <div className=' box p-10 rounded-3xl relative  m-20 mr-35  flex items-center justify-center flex-col bg-blue-900/20'>
          ...
          <div className='relative w-full'>
           <input
            ...
            />
            <img className='lview invert absolute top-2 left-98' width={32} src={ispassword? './view.png':'./hide.png'} alt="" onClick={()=>showpassword()}/>
             </div>
