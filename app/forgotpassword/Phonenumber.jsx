  ...
  return (
    <>
      ...
      <div className="w-[35%] forgotbox  bg-purple-900/30   rounded-3xl flex flex-col items-center  mx-auto my-10 animate-fade-in-center">
        ...
        <div className="enter text-white text-xl mb-3 mr-69 animate-fade-in-up">Enter  phone number</div>
        <div className="phone flex ml-20 w-[100%] gap-4 ">
          <input
            type="tel"
            className="inpphone animate-fade-in-up  text-white  w-3/5 mb-2 rounded-2xl focus:border-2 px-3 py-2.5 text-lg bg-slate-800"
          ...
          <div>
            <button
              ...
              className="bu bu1 animate-fade-in-up  text-white text-xl bg-gradient-to-br from-blue-500 to-blue-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg px-2.5 py-2"
            >
              Search
            </button>
          </div>
        </div>
        <div className='error text-red-500 w-80  mr-30 font-medium  mb-1'>{phoneerror}</div>
        {fond && <>
          <div className="text-white flex flex-col justify-start">
            <div className='text-2xl text-blue-500 mr-75 mb-3 animate-fade-in-down'>Account found</div>
            <div className='text-xl mb-2 ml-3 animate-fade-in-down'>Username</div>
            <div>
          ...
          <div className="animate-fade-in-down t m logo text-white text-lg mr-65 mb-2">Enter New password</div>
          <div className='animate-fade-in-down relative w-4/5'>

            <input
              className="input i1 logo  text-white  w-full mb-1 rounded-xl focus:border-2 px-3 py-2.5 text-xl bg-slate-800"
          ...
          <div className='error text-red-500 w-80  font-medium mr-22 mb-1'>{passwerror}</div>

          <div className="animate-fade-in-up t m logo text-white text-lg mr-65 mb-2">Confirm password</div>
          <div className='animate-fade-in-down relative w-4/5'>
