    ...
    <>
      ...
      <div className="container box  animate-fade-in-center w-150 good mx-auto bg-purple-900/30  mt-8 rounded-4xl ">
        ...
        <div className="logo">
          ...
          <div className="animate-fade-in-up t m logo text-blue-500 text-lg mx-15 mb-2">Enter your Password</div>
          ...
          <input
            ...
            autoComplete="off"
            className="input m logo animate-fade-in-up text-white border  border-slate-600 w-11/12 sm:w-4/5 mb-2 rounded-2xl focus:border-2 px-3 py-2.5 text-lg bg-slate-800 ml-20 z-10 relative"
          />
          ...
          <input
            className="animate-fade-in-up input m logo text-white ml-20 w-4/5 mb-2 rounded-2xl focus:border-2 px-3 py-2.5 text-lg bg-slate-800"
            type="email"
