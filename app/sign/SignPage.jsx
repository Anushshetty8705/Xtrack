  ...
  return (
    <>
      ...
      <div className="container box  animate-fade-in-center w-150 good mx-auto bg-purple-900/30  mt-8 rounded-4xl ">
        ...
        <div className="logo">
          <div className="animate-fade-in-up t m logo text-white text-lg mx-15 mb-2">Enter your username</div>
          <input
            type="text"
          ...
          <div className="animate-fade-in-up t m logo text-white text-lg mx-15 mb-2">Enter your Password</div>
          ...
          <div className="animate-fade-in-up t m logo text-white text-lg mx-15 mb-3">Enter your Phone Number</div>
          <input
            type="tel"
            inputMode="numeric"
            pattern="[0-9]*"
          ...
          <div className="animate-fade-in-up t m logo text-white text-lg mx-15 mb-2">Enter your Email</div>
          <input
